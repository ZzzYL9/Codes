...
void ReBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ReBook::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReBook::rebook)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ReBook::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ReBook.data,
    qt_meta_data_ReBook,
    qt_static_metacall,
    nullptr,
    nullptr
