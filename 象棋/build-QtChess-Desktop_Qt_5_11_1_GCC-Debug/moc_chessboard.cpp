...
QT_MOC_LITERAL(1, 11, 6), // "doMove"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5) // "index"

    },
    "ChessBoard\0doMove\0\0index"
};
...
void ChessBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doMove((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessBoard::doMove)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChessBoard::doMove(int _t1)
{
